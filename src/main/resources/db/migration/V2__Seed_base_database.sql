INSERT INTO "user" VALUES (DEFAULT, 'gdownes', 'gdownes@gmail.com', 'reset_token', 'access_token', 'password', TRUE, now(), now(), 1);
...
INSERT INTO "check" VALUES (DEFAULT, 1, NULL, 'Google', 'http://www.google.com/', 'Europe', 'UNKNOWN'::status, 'WAITING'::state, now(), now(), now(), NULL, 1, FALSE, 1);
INSERT INTO "check" VALUES (DEFAULT, 1, NULL, 'Facebook', 'http://www.facebook.com/', 'Europe', 'UNKNOWN'::status, 'WAITING'::state, now(), now(), now(), NULL, 1, FALSE, 1);
